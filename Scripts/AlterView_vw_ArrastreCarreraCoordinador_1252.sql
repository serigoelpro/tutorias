/* =========================================================================
   ALTER VIEW vw_ArrastreCarreraCoordinador
   -------------------------------------------------------------------------
   Cambio: Filtro de especialidad con NOT EXISTS para cubrir alumnos cuyas
   materias solo existen en catálogo bajo una especialidad distinta a la suya
   (ej: Licenciatura cuyas materias están catalogadas como TSU).

   Comportamiento:
     - Si la materia coincide exactamente con la especialidad del alumno ? se muestra.
     - Si la materia no tiene especialidad (NULL / 0) ? se muestra.
     - Si NO existe ninguna otra versión de la misma materia con la especialidad
       correcta del alumno ? se muestran TODAS las copias (duplicados incluidos).
       El usuario puede eliminar el registro duplicado directamente desde la vista.

   Ejemplos verificados:
     ? Gonzalez Garcia Hanna  (25AD009186) - materias huérfanas visibles
     ? Sanchez Flores Eduardo (25AD009091) - materias huérfanas visibles
     ? Duplicados reales: ambas copias visibles para que el usuario decida cuál borrar
   ========================================================================= */
